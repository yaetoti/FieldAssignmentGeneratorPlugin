...
namespace JetBrains.Rider.Model
{
  ...
  /// <summary>
  /// <p>Generated from: IdeRoot.kt:9</p>
  /// </summary>
  public class MyUnityModel : RdExtBase
  {
    //fields
    //public fields
    ...
    protected override long SerializationHash => 1571249539621133726L;
    ...
    public MyUnityModel(Lifetime lifetime, IProtocol protocol) : this()
    {
      Identify(protocol.Identities, RdId.Root.Mix("MyUnityModel"));
      this.BindTopLevel(lifetime, protocol, "MyUnityModel");
    }
  ...
  /// <summary>
  /// <p>Generated from: IdeRoot.kt:12</p>
  /// </summary>
  public enum MyEnum {
    FirstValue,
    SecondValue
  ...
  /// <summary>
  /// <p>Generated from: IdeRoot.kt:17</p>
  /// </summary>
