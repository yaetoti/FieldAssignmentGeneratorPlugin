...
namespace ReSharperPlugin.FieldAssignmentGenerator
{
  ...
  {
    private static readonly ILogger ourLog = Logger.GetLogger("ReSharperPlugin.FieldAssignmentGenerator.Actions");
      ...
      CultureContextComponent.Instance.Change.Advise(Lifetime.Eternal, args =>
      {
          ...
          if (instance != null)
          {
            ourResourceManager = new Lazy<JetResourceManager>(
              ...
              {
                return instance
                  .CreateResourceManager("ReSharperPlugin.FieldAssignmentGenerator.Actions", typeof(Actions).Assembly);
              });
          }
          else
          {
